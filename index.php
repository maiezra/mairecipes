...
<div class="container mt-5">
    ...
    <div class="text-center mb-4">
        <img src="assets/logo.jpg" alt="Website Logo" class="img-fluid" style="max-width: 400px;">
    </div>
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card tip-card">
                    <img src="assets/tip1.png" class="card-img-top" alt="Tip 1">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card tip-card">
                    <img src="assets/water.png" class="card-img-top" alt="Tip 2">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card tip-card">
                    <img src="assets/whole grains.png" class="card-img-top" alt="Tip 3">
                    <div class="card-body">
